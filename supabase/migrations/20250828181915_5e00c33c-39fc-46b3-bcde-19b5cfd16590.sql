-- Insert sample data with correct proficiency values (1-5 scale)
...
-- Insert sample skills with correct proficiency scale (1-5)
INSERT INTO public.skills (name, category, proficiency, years_experience, icon, display_order) VALUES
('React', 'Frontend', 5, 5, 'react', 1),
('TypeScript', 'Frontend', 5, 4, 'typescript', 2),
('Node.js', 'Backend', 4, 4, 'nodejs', 3),
('PostgreSQL', 'Database', 4, 3, 'database', 4),
('Python', 'Backend', 4, 3, 'python', 5),
('AWS', 'DevOps', 3, 2, 'cloud', 6),
('Docker', 'DevOps', 4, 2, 'container', 7),
('Git', 'Tools', 5, 5, 'git-branch', 8);
